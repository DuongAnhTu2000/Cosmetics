            ...
            <TabContext value={value}>
              <Box>
                <TabList onChange={handleChange} variant="fullWidth">
                  <Tab label="Login" value="1" className="tab--style" disableRipple={true} />
                  <Tab label="Register" value="2" to="/register" className="tab--style" disableRipple={true} />
                  <Tab label="Reset Pass" value="3" to="/reset-password" className="tab--style" disableRipple={true} />
                </TabList>
              </Box>
              <div className="modal--content">
                ...
                <TabPanel value="2">
                  ...
                  <div className="modal--input">
                    <input type="text" name="username" size={37} aria-required="true" placeholder="User Name *" />
                    <input type="email" name="email" size={37} aria-required="true" placeholder="Email *" />
                    <input type="password" name="password" size={37} aria-required="true" placeholder="Password *" />
                    <input
                      type="password"
